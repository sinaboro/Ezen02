...
public class WT_Main {
	...
	public static void main(String[] args) {
		...
		while (true) {
			System.out.println("======================================");
			System.out.println("C   0.CREATE 웹툰 정보 생성 및 최신화     T");
			System.out.println("R   1.READ 웹툰 검색                   E");
			System.out.println("U   2.UPDATE 웹툰 추가/수정             A");
			System.out.println("D   3.DELETE 웹툰 삭제                 M");
			System.out.println("6   9.EXIT 프로그램 종료                6");
			System.out.println("======================================");
			System.out.print(">>");
